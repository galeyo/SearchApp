...
namespace Persistence.Migrations
{
    ...
    [Migration("20201116223325_InitialContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.AircraftCategory", b =>
                {
                    ...
                    b.HasKey("AircraftId", "CategoryId");

                    b.HasIndex("CategoryId");

                    b.ToTable("AircraftCategory");
                });

            modelBuilder.Entity("Domain.AircraftType", b =>
                {
                    b.Property<int>("AircraftId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.AircraftCategory", b =>
                {
                    b.HasOne("Domain.Aircraft", "Aircraft")
                        .WithMany("AircraftCategory")
                        .HasForeignKey("AircraftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Category", "Category")
                        .WithMany("AircraftCategories")
